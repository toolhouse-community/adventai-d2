# Hello AdventAI - Day 2️⃣

![Banner](repository-assets/banner.png)

[![Fork](https://img.shields.io/badge/CLONE%20THIS%20REPO-0088FF?style=for-the-badge)](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d2&owner=%40me&name=th-adventai-d2&description=AdventAI+Day+2+Fork&visibility=public)

## Table of Contents

- [Hello AdventAI - Day 2️⃣](#hello-adventai---day-2️⃣)
...
![Screengrab](repository-assets/x_screen.gif)

On Day 2️⃣, we are unwrapping an AI-powered social media monitoring app that harnesses the `search_x` tool to curate and deliver comprehensive daily insights from X (formerly Twitter), straight to your email.
...
> [!NOTE]
> This app requires the `send_email`, `memory_fetch`, `memory_store`, and `search_x` tools.
...
- [![Fork](https://img.shields.io/badge/CLONE%20THIS%20REPO-0088FF?style=for-the-badge)](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d2&owner=%40me&name=th-adventai-d2&description=AdventAI+Day+2+Fork&visibility=public)
  ...
  Or Create a [Fork](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d2&owner=%40me&name=th-project&description=AdventAI+Day+2+Fork&visibility=public)
...
[Back to Top ⬆️](#hello-adventai---day-2️⃣)